...
const Ticket_list_employee = () => {
    ...
    const fetchTickets = async () => {
        try {
            const response = await axios.get(`${config.apiBASEURL}/ticketRoutes/tickets/raiser/${userId}`, {
    ...
    const handleConfirmationDialog = (proceed) => {
        if (proceed) {
        ...
        <>
            <Row className="body_content">
                <Row className="mx-0">
                    ...
                    <Col xs={6} sm={6} lg={8} className="mb-4 d-flex justify-content-end align-items-center text-end">
                        <Button
                            label="Add Ticket"
                            icon="pi pi-ticket"
                            severity="help"
                    ...
                    <Col sm={12} lg={12} className="mb-2">
                        <Card className="d-lg-flex d-block d-md-flex d-sm-flex justify-content-end align-items-center p-2 shadow-0 responsiveView" style={{ flexDirection: 'row' }}>
                                        ...
                                        <Card>
                                            ...
                                            <Card.Body className='pb-0'>
                                                ...
                                                <p>
                                                    ...
                                                    <span>
                                                        <Avatar image={ticket.resolver?.profileImage.image_url || noUserImage} shape="circle" className="logo" data-pr-tooltip={ticket.resolver?.first_namename || "Unassigned"} />
                    ...
                    >
                        <p>
                            Raising a ticket is an irreversible process. Once a ticket is raised, it cannot be deleted.
...
export default Ticket_list_employee;